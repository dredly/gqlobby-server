...
exports.removeGame = exports.endGame = exports.startGame = exports.toggleReady = exports.joinGame = exports.createGame = exports.createPlayer = exports.createLobby = void 0;
...
var startGame = function (playerId, lobby) {
    var game = lobby.games.find(function (g) { return g.players.map(function (p) { return p.id; }).includes(playerId); });
    if (!game) {
        throw new Error('A game containing that player was not found');
    }
    ...
    lobby.games = lobby.games.map(function (g) { return g.id === game.id ? updatedGame : g; });
    return updatedGame;
};
exports.startGame = startGame;
var endGame = function (gameId, lobby) {
    var game = lobby.games.find(function (g) { return g.id === gameId; });
    if (!game) {
        throw new Error('A game with that id was not found');
    }
    ...
    var endedGame = __assign(__assign({}, cd(game)), { status: 'FINISHED' });
    lobby.games = lobby.games.map(function (g) { return g.id === gameId ? endedGame : g; });
    return endedGame;
};
exports.endGame = endGame;
var removeGame = function (gameId, lobby) {
    var game = lobby.games.find(function (g) { return g.id === gameId; });
    if (!game) {
        throw new Error('A game with that id was not found');
    }
    lobby.games = lobby.games.filter(function (g) { return g.id !== gameId; });
    return game;
};
