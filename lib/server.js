...
var startLobbyServer = function (lobbyOptions) { return __awaiter(void 0, void 0, void 0, function () {
    var app, httpServer, lobby, schema, wsServer, serverCleanup, server, PORT;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                app = (0, express_1.default)();
                httpServer = http_1.default.createServer(app);
                lobby = (0, actions_1.createLobby)(lobbyOptions ? lobbyOptions : constants_1.DEFAULT_LOBBY_OPTIONS);
                schema = (0, schema_1.makeExecutableSchema)({ typeDefs: typeDefs_1.typeDefs, resolvers: (0, resolvers_1.getResolvers)(lobby) });
