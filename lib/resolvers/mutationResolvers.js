...
exports.mutationResolvers = {
    createPlayer: function (_root, args) { return (0, actions_1.createPlayer)(args.name, resolvers_1.lobby); },
    createGame: function (_root, args) {
        var newGame = (0, actions_2.createGame)(args.playerID, resolvers_1.lobby);
        void resolvers_1.pubsub.publish('GAME_ADDED', { gameAdded: newGame });
        return newGame;
    },
    joinGame: function (_root, args) {
        var joinedGame = (0, actions_3.joinGame)(args.gameID, args.playerID, resolvers_1.lobby);
        void resolvers_1.pubsub.publish('GAME_UPDATED', { gameUpdated: joinedGame });
        return joinedGame;
    },
    toggleReady: function (_root, args) {
        var updatedGame = (0, actions_4.toggleReady)(args.playerID, resolvers_1.lobby);
        void resolvers_1.pubsub.publish('GAME_UPDATED', { gameUpdated: updatedGame });
        return updatedGame;
    },
    startGame: function (_root, args) {
        var startedGame = (0, actions_5.startGame)(args.playerID, resolvers_1.lobby);
